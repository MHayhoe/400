...
%comment colors
\newcommand{\he}[1]{{\ifdraft\color{blue}[Hadi: {#1}]\fi}}
\newcommand{\mh}[1]{{\ifdraft\color{red}[Mikhail: {#1}]\fi}}
\newcommand{\hk}[1]{{\ifdraft\color{magenta}[Harshat: {#1}]\fi}}
\newcommand{\mf}[1]{{\ifdraft\color{green}[Mohammad: {#1}]\fi}}
...
\input{ack}
\appendix
\section{Heuristic AI}
\input{heuristicai}
\section{Evolutionary AI}
\input{evolutionaryai}
\newpage
%============================= BIBLIOGRAPHY ===============================
